...
<!-- Modal daftar berhasil -->
  <div class="modal fade message-sent noselect" id="sentSuccessDaftarModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        <div class="modal-body p-0 text-center">
          <img src="img/vector/tick.png" class="mb-4" style="width:132px;height:132px;margin-top: 30px">
  ...
  <?php if (isset($_SESSION['isKirim']) && $_SESSION['isKirim'] == 'DaftarAcademySend') { ?>
    <script>
      $(document).ready(function() {
        $('#sentSuccessDaftarModal').modal('show');
      });
    </script>
  <?php } ?>
