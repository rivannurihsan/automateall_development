...
<section class="referral academy noselect">
    <div class="container">
        ...
        <!--</div>-->
        <?php echo "<script>console.log('Debug Objects: " .$tanggal.$jamulai. "' );</script>"; ?>
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-body p-0 text-center">
                ...
                <p>Kami akan segera mengirimkan konfirmasi ke email anda</p>
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-body p-0 text-center">
                ...
                <p>Mohon maaf pesan tidak terkirim, mohon hubungi contact@automateall.id untuk mendapatkan code referral</p>
                <button type="button" class="btn" data-dismiss="modal">OK</button>
                <img src="/img/vector/ellipse.png" class="img-fluid ellipse" alt="ellipse">
            </div>
        </div>
...
<script>
    $(document).ready(function () {
        $('#sentSuccessModal').modal('show');
    });
</script>
<?php } elseif($isKirim == 'notSent'){ ?>
    <script>
        $(document).ready(function () {
