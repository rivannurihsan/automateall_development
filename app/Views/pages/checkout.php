      ...
      <div class="col col-lg-7">
        <div class="content_wrapper">
          ...
          <div class="content__texWrapper">
            <p class="content__textRight">: <?= $kategori ?></p>
        ...
        <?php if (!isset($keterangan)) { ?>
          <form class="formKode" method="POST" action="<?= (isset($code))?base_url('/delCoupon?id='.$_GET['id']):base_url('/useCoupon?id='.$_GET['id']) ?>">
        <?php } ?>
            ...
            <?php if(!isset($code) && !isset($keterangan)){ ?>
              ...
              <input name="id" value="<?= $id ?>" style="display: none;" readonly>
            <?php }else{ ?>
        ...
        <div class="table__wrapper">
          ...
          <div class="text__buktiWrapper">
              <div class="text__wrapper" <?= (!$isBuktiBayar)?'style="border:0px"':null ?>>
                <?php if (!isset($keterangan)) { ?>
                  <form action="<?=base_url('/checkout?id='.$_GET['id'])?>" name="ajax_form" id="checkout" method="post" accept-charset="utf-8" enctype="multipart/form-data">
